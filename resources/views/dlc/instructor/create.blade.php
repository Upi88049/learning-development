...
@section('title', 'Tambah Instruktur | Dharma Learning Center')
...
<main class="dashboard-content">
    <div class="container-fluid px-3 px-lg-4 py-4">
            ...
            <div class="d-flex flex-column flex-md-row align-items-md-center justify-content-between gap-3">
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div>
                        ...
                        <h1 class="h3 mb-1 fw-bold text-dark">Tambah Instruktur Baru</h1>
                        <p class="text-muted mb-0 small">Tambahkan trainer, pembicara, atau instruktur ke dalam database master.</p>
                    </div>
                </div>
        ...
        <form action="{{ route('instructor.store') }}" method="POST" class="panel p-4">
            @csrf
            <div class="panel-header border-bottom pb-3 mb-3">
                <h2 class="h5 mb-1 section-title">
                    <i class="bi bi-card-text me-2 text-primary" aria-hidden="true"></i>
                    <span>Informasi Instruktur</span>
                </h2>
                <p class="text-muted mb-0 small">Lengkapi kode identitas/NPK instruktur dan nama lengkap.</p>
            </div>
            ...
            <div class="row g-3">
                ...
                <div class="col-12 col-md-5">
                    ...
                    <input type="text"
                           ...
                           value="{{ old('instructor_code') }}"
                           placeholder="Contoh: 11230231 / NPK / Kode Unik"
                           required>
                ...
                <div class="col-12 col-md-4">
                    ...
                    <input type="text"
                           ...
                           placeholder="Contoh: Leadership, Safety, K3, IT">
                ...
                <div class="col-12 col-md-4">
                    ...
                    <input type="email"
                           ...
                           name="email"
                           value="{{ old('email') }}"
                           placeholder="Contoh: instruktur@dharmap.com">
                    @error('email')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="d-flex justify-content-end align-items-center gap-2 mt-4 pt-3 border-top">
                ...
                <button type="submit" class="btn btn-primary">
                    <i class="bi bi-save me-1" aria-hidden="true"></i> Simpan Instruktur
                </button>
            </div>
        </form>
    </div>
