...
<main class="admin-content">
    <div class="container-fluid px-3 px-lg-4 py-4">
                        ...
                        <div class="d-flex align-items-center gap-2 mb-1">
                            ...
                            @else
                                <span class="badge bg-secondary-subtle text-secondary rounded-pill px-2 py-1" style="font-size: 0.72rem;">
                                    Draft Belum Dikirim ke IM
                                </span>
                            @endif
                        </div>
                        <h1 class="h4 mb-1 text-dark fw-bold">Edit Formulir Penugasan Training</h1>
                        <p class="text-muted mb-0 small">{{ $penugasan->nama_training }}</p>
                    </div>
                </div>
                <div class="d-flex gap-2">
                    <a href="{{ route('penugasan.previewPdf', $penugasan->id_penugasan) }}" target="_blank" class="btn btn-outline-info btn-sm px-3 py-2 rounded-3 d-inline-flex align-items-center gap-1">
                        <i class="bi bi-eye"></i> Preview PDF
                    </a>
                    <a href="{{ route('penugasan.index') }}" class="btn btn-outline-secondary btn-sm px-3 py-2 rounded-3 d-inline-flex align-items-center gap-1">
        ...
        <div class="alert alert-info border-0 shadow-sm d-flex align-items-center gap-3 mb-4 p-3 rounded-3" style="background-color: #eff6ff; border-left: 4px solid #3b82f6 !important;">
            ...
            <div>
                <strong class="d-block text-dark">Terkait Request Out House: {{ $penugasan->requestOuthouse->no_request }}</strong>
                <small class="text-muted">
                    Formulir ini terhubung dengan permohonan staff <strong>{{ $penugasan->requestOuthouse->staff ? $penugasan->requestOuthouse->staff->nama_staff : '-' }}</strong>.
                </small>
            </div>
        </div>
        @endif
        ...
        <form action="{{ route('penugasan.update', $penugasan->id_penugasan) }}" method="POST" id="formPenugasan">
            ...
            <div class="step-panel">
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control form-control-smooth" id="nama_training" name="nama_training" value="{{ old('nama_training', $penugasan->nama_training) }}" required>
                    </div>

                    <div class="col-md-6">
                        <label for="jenis_training" class="form-label-smooth">Jenis Training <span class="text-danger">*</span></label>
                        <input type="text" class="form-control form-control-smooth" id="jenis_training" name="jenis_training" value="{{ old('jenis_training', $penugasan->jenis_training) }}" required>
                    </div>

                    <div class="col-md-5">
                        <label for="sub_co" class="form-label-smooth">SubCo <span class="text-danger">*</span></label>
                        <input type="text" class="form-control form-control-smooth" id="sub_co" name="sub_co" value="{{ old('sub_co', $penugasan->sub_co) }}" required>
                    </div>

                    <div class="col-md-4">
                        <label for="divisi" class="form-label-smooth">Divisi <span class="text-danger">*</span></label>
                        <input type="text" class="form-control form-control-smooth" id="divisi" name="divisi" value="{{ old('divisi', $penugasan->divisi) }}" required>
                    </div>

                    <div class="col-md-3">
                        <label for="no_form" class="form-label-smooth">No. Dokumen</label>
                        <input type="text" class="form-control form-control-smooth font-monospace" id="no_form" name="no_form" value="{{ old('no_form', $penugasan->no_form) }}">
                    </div>
                </div>
            </div>
                ...
                <div class="row g-3 align-items-center">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" step="any" class="form-control form-control-smooth" id="biaya_per_peserta" name="biaya_per_peserta" value="{{ old('biaya_per_peserta', $penugasan->biaya_per_peserta) }}" placeholder="0" required>
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        ...
                        <input type="text" class="form-control form-control-smooth font-monospace" id="terbilang" name="terbilang" value="{{ old('terbilang', $penugasan->terbilang) }}" placeholder="Otomatis terisi kalimat terbilang...">
            ...
            <div class="step-panel">
                ...
                <div>
                    ...
                    <textarea class="form-control form-control-smooth" id="alasan_pelatihan" name="alasan_pelatihan" rows="3">{{ old('alasan_pelatihan', $penugasan->alasan_pelatihan) }}</textarea>
                </div>
            </div>
            ...
            <div class="step-panel">
                ...
                <div class="row g-3">
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control form-control-smooth" id="nama_atasan" name="nama_atasan" value="{{ old('nama_atasan', $penugasan->nama_atasan) }}">
                    </div>

                    <div class="col-md-4">
                        <label for="divisi_atasan" class="form-label-smooth">Divisi Atasan</label>
                        <input type="text" class="form-control form-control-smooth" id="divisi_atasan" name="divisi_atasan" value="{{ old('divisi_atasan', $penugasan->divisi_atasan) }}">
                    </div>

                    <div class="col-md-4">
                        <label for="jabatan_atasan" class="form-label-smooth">Jabatan Atasan</label>
                        <input type="text" class="form-control form-control-smooth" id="jabatan_atasan" name="jabatan_atasan" value="{{ old('jabatan_atasan', $penugasan->jabatan_atasan) }}">
                    </div>

                    <div class="col-12">
                        <label for="tempat_tanggal_training" class="form-label-smooth">Tempat &amp; Tanggal Penyelenggaraan Training</label>
                        <textarea class="form-control form-control-smooth" id="tempat_tanggal_training" name="tempat_tanggal_training" rows="2">{{ old('tempat_tanggal_training', $penugasan->tempat_tanggal_training) }}</textarea>
                    </div>

                    <div class="col-12">
                        <label for="tempat_tanggal_persetujuan" class="form-label-smooth">Tempat &amp; Tanggal Dokumen</label>
                        <input type="text" class="form-control form-control-smooth" id="tempat_tanggal_persetujuan" name="tempat_tanggal_persetujuan" value="{{ old('tempat_tanggal_persetujuan', $penugasan->tempat_tanggal_persetujuan) }}">
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control form-control-smooth" id="nama_im" name="nama_im" value="{{ old('nama_im', $penugasan->nama_im) }}" placeholder="Contoh: Tony Herdian">
                    </div>

                    <div class="col-md-6">
                        <label for="bagian_im" class="form-label-smooth">Bagian / Jabatan Immediate Manager</label>
                        <input type="text" class="form-control form-control-smooth" id="bagian_im" name="bagian_im" value="{{ old('bagian_im', $penugasan->bagian_im) }}" placeholder="Contoh: Business Unit Head Fastener">
                    </div>

                    <div class="col-md-6">
                        <label for="nama_direktur" class="form-label-smooth">Nama Direktur</label>
                        <input type="text" class="form-control form-control-smooth" id="nama_direktur" name="nama_direktur" value="{{ old('nama_direktur', $penugasan->nama_direktur ?: 'Dian Eka Hartiningsih') }}" placeholder="Contoh: Dian Eka Hartiningsih">
                    </div>

                    <div class="col-md-6">
                        <label for="jabatan_direktur" class="form-label-smooth">Jabatan Direktur</label>
                        <input type="text" class="form-control form-control-smooth" id="jabatan_direktur" name="jabatan_direktur" value="{{ old('jabatan_direktur', $penugasan->jabatan_direktur ?: 'Director') }}" placeholder="Director">
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control form-control-smooth" id="konfirmasi_nama" name="konfirmasi_nama" value="{{ old('konfirmasi_nama', $penugasan->konfirmasi_nama) }}">
                    </div>

                    <div class="col-md-6">
                        <label for="konfirmasi_jabatan" class="form-label-smooth">Jabatan Konfirmasi DLC</label>
                        <input type="text" class="form-control form-control-smooth" id="konfirmasi_jabatan" name="konfirmasi_jabatan" value="{{ old('konfirmasi_jabatan', $penugasan->konfirmasi_jabatan ?: 'HRD Deputy Div. Head') }}">
                    </div>
                </div>
            </div>
