        ...
        <form action="{{ route('penugasan.store') }}" method="POST" id="formPenugasan">
            ...
            <div class="panel p-4 mb-4">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-12">
                        ...
                        <textarea class="form-control" id="tempat_tanggal_training" name="tempat_tanggal_training" rows="2" placeholder="Contoh: Hotel Santika Cikarang / Online Zoom, 15 - 16 April 2026 (08.30 - 17.00 WIB)">{{ old('tempat_tanggal_training', $defaultData['tempat_tanggal_training']) }}</textarea>
                    </div>

                    <div class="col-md-6">
                        <label for="tempat_tanggal_persetujuan" class="form-label fw-semibold">Tempat &amp; Tanggal Dokumen</label>
                        <input type="text" class="form-control" id="tempat_tanggal_persetujuan" name="tempat_tanggal_persetujuan" value="{{ old('tempat_tanggal_persetujuan', $defaultData['tempat_tanggal_persetujuan']) }}" placeholder="Contoh: Cikarang, 30 Maret 2026">
                    </div>

                    <div class="col-md-6">
                        <label for="penyetujui_jabatan" class="form-label fw-semibold">Jabatan Penyetujui (Disetujui,)</label>
                        <input type="text" class="form-control" id="penyetujui_jabatan" name="penyetujui_jabatan" value="{{ old('penyetujui_jabatan', $defaultData['penyetujui_jabatan']) }}" placeholder="Director">
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="konfirmasi_jabatan" name="konfirmasi_jabatan" value="{{ old('konfirmasi_jabatan', $defaultData['konfirmasi_jabatan']) }}" placeholder="HRGA Deputy Div. Head">
                    </div>
                </div>
            </div>
            ...
            <div class="d-flex flex-wrap justify-content-end gap-3 my-4">
                ...
                <button type="submit" class="btn btn-primary px-4">
                    <i class="bi bi-save me-1"></i> Simpan Formulir
                </button>
