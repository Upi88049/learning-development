    ...
    <div class="container-fluid px-3 px-lg-4 py-4">
        ...
        <div class="page-heading mb-4 d-flex flex-wrap align-items-center justify-content-between gap-3">
            <div class="page-heading-copy">
                ...
                <div>
                    <h1 class="h3 mb-1">Buat Formulir Pendaftaran &amp; Penugasan Training</h1>
                    <p class="text-muted mb-0">Isi data formulir penugasan training resmi Dharma Learning Center.</p>
                </div>
            </div>
            <div>
                <a href="{{ route('penugasan.index') }}" class="btn btn-outline-secondary">
                    <i class="bi bi-arrow-left me-1"></i> Kembali ke Daftar Form
                </a>
            </div>
        </div>
        ...
        <div class="alert alert-info d-flex align-items-center gap-2 mb-4">
            ...
            <div>
                Formulir ini dibuat berdasarkan <strong>Request Out House (No: {{ $requestOuthouse->no_request }})</strong> untuk staff <strong>{{ $requestOuthouse->staff ? $requestOuthouse->staff->nama_staff : '-' }}</strong>. Data telah diisikan secara otomatis.
            </div>
        </div>
        @endif
        ...
        <form action="{{ route('penugasan.store') }}" method="POST" id="formPenugasan">
            ...
            <div class="panel p-4 mb-4">
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="nama_training" name="nama_training" value="{{ old('nama_training', $defaultData['nama_training']) }}" placeholder="Contoh: Problem Solving (PDCA), ISO 9001:2015, dll." required>
                    </div>

                    <div class="col-md-6">
                        <label for="jenis_training" class="form-label fw-semibold">Jenis Training <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" id="jenis_training" name="jenis_training" value="{{ old('jenis_training', $defaultData['jenis_training']) }}" placeholder="Contoh: Out House Training / Technical / Leadership" required>
                    </div>

                    <div class="col-md-6">
                        <label for="sub_co" class="form-label fw-semibold">SubCo <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" id="sub_co" name="sub_co" value="{{ old('sub_co', $defaultData['sub_co']) }}" placeholder="Contoh: PT. Dharma Polimetal Tbk" required>
                    </div>

                    <div class="col-md-4">
                        <label for="divisi" class="form-label fw-semibold">Divisi <span class="text-danger">*</span></label>
                        <input type="text" class="form-control" id="divisi" name="divisi" value="{{ old('divisi', $defaultData['divisi']) }}" placeholder="Contoh: Human Capital & General Affairs" required>
                    </div>

                    <div class="col-md-2">
                        <label for="no_form" class="form-label fw-semibold">No. Dokumen</label>
                        <input type="text" class="form-control" id="no_form" name="no_form" value="{{ old('no_form', $defaultData['no_form']) }}">
                    </div>
                </div>
            </div>
            ...
            <div class="panel p-4 mb-4">
                ...
                <div class="row g-3">
                    <div class="col-md-3">
                        ...
                        <input type="number" class="form-control bg-light" id="jumlah_peserta" name="jumlah_peserta" value="{{ old('jumlah_peserta', count($pesertaRows)) }}" readonly>
                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" step="any" class="form-control" id="biaya_per_peserta" name="biaya_per_peserta" value="{{ old('biaya_per_peserta', $defaultData['biaya_per_peserta']) }}" placeholder="0" required>
                        </div>
                    </div>
                    ...
                    <div class="col-md-5">
                        ...
                        <div class="input-group">
                            <span class="input-group-text">Rp</span>
                            <input type="text" class="form-control bg-light fw-bold text-success" id="total_biaya_display" value="0" readonly>
                        </div>
                    </div>

                    <div class="col-12">
                        <label for="terbilang" class="form-label fw-semibold">Terbilang</label>
                        <input type="text" class="form-control bg-light" id="terbilang" name="terbilang" value="{{ old('terbilang', $defaultData['terbilang']) }}" placeholder="Otomatis terisi kalimat terbilang...">
            ...
            <div class="panel p-4 mb-4">
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" id="alasan_pelatihan" name="alasan_pelatihan" rows="3" placeholder="Tuliskan tujuan, urgensi bisnis, atau kompetensi yang diharapkan...">{{ old('alasan_pelatihan', $defaultData['alasan_pelatihan']) }}</textarea>
                </div>
            </div>
            ...
            <div class="panel p-4 mb-4">
                ...
                <div class="row g-3">
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control" id="nama_atasan" name="nama_atasan" value="{{ old('nama_atasan', $defaultData['nama_atasan']) }}" placeholder="Nama Atasan Langsung">
                    </div>

                    <div class="col-md-4">
                        <label for="divisi_atasan" class="form-label fw-semibold">Divisi Atasan</label>
                        <input type="text" class="form-control" id="divisi_atasan" name="divisi_atasan" value="{{ old('divisi_atasan', $defaultData['divisi_atasan']) }}" placeholder="Divisi Atasan">
                    </div>

                    <div class="col-md-4">
                        <label for="jabatan_atasan" class="form-label fw-semibold">Jabatan Atasan</label>
                        <input type="text" class="form-control" id="jabatan_atasan" name="jabatan_atasan" value="{{ old('jabatan_atasan', $defaultData['jabatan_atasan']) }}" placeholder="Contoh: Department Head / Division Head">
                    </div>

                    <div class="col-12">
                        <label for="tempat_tanggal_training" class="form-label fw-semibold">Tempat &amp; Tanggal Penyelenggaraan Training</label>
                        <textarea class="form-control" id="tempat_tanggal_training" name="tempat_tanggal_training" rows="2" placeholder="Contoh: 17 - 19 Februari 2025, PAKO Karawang Plant">{{ old('tempat_tanggal_training', $defaultData['tempat_tanggal_training']) }}</textarea>
                    </div>

                    <div class="col-12">
                        <label for="tempat_tanggal_persetujuan" class="form-label fw-semibold">Tempat &amp; Tanggal Dokumen</label>
                        <input type="text" class="form-control" id="tempat_tanggal_persetujuan" name="tempat_tanggal_persetujuan" value="{{ old('tempat_tanggal_persetujuan', $defaultData['tempat_tanggal_persetujuan']) }}" placeholder="Contoh: Cikarang, 6 Februari 2025">
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="nama_im" name="nama_im" value="{{ old('nama_im', $defaultData['nama_im']) }}" placeholder="Contoh: Tony Herdian">
                    </div>

                    <div class="col-md-6">
                        <label for="bagian_im" class="form-label fw-semibold">Bagian / Jabatan Immediate Manager</label>
                        <input type="text" class="form-control" id="bagian_im" name="bagian_im" value="{{ old('bagian_im', $defaultData['bagian_im']) }}" placeholder="Contoh: Business Unit Head Fastener">
                    </div>

                    <div class="col-md-6">
                        <label for="nama_direktur" class="form-label fw-semibold">Nama Direktur</label>
                        <input type="text" class="form-control" id="nama_direktur" name="nama_direktur" value="{{ old('nama_direktur', $defaultData['nama_direktur']) }}" placeholder="Contoh: Yosaphat P. Simanjuntak">
                    </div>

                    <div class="col-md-6">
                        <label for="jabatan_direktur" class="form-label fw-semibold">Jabatan Direktur</label>
                        <input type="text" class="form-control" id="jabatan_direktur" name="jabatan_direktur" value="{{ old('jabatan_direktur', $defaultData['jabatan_direktur']) }}" placeholder="Director">
                    </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="konfirmasi_nama" name="konfirmasi_nama" value="{{ old('konfirmasi_nama', $defaultData['konfirmasi_nama']) }}" placeholder="Herwin Gultom">
                    </div>

                    <div class="col-md-6">
                        <label for="konfirmasi_jabatan" class="form-label fw-semibold">Jabatan Konfirmasi DLC</label>
                        <input type="text" class="form-control" id="konfirmasi_jabatan" name="konfirmasi_jabatan" value="{{ old('konfirmasi_jabatan', $defaultData['konfirmasi_jabatan']) }}" placeholder="HRD Deputy Div. Head">
                    </div>
                </div>
            </div>
            ...
            <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 my-4">
                <div class="form-check">
                    <input class="form-check-input" type="checkbox" name="is_sent" value="1" id="checkIsSent" {{ old('is_sent', false) ? 'checked' : '' }}>
