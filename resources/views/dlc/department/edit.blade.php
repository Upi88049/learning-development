            ...
            <div class="col-12 col-xl-6">
                <form action="{{ route('department.update', $department->id_department) }}" method="POST" class="panel p-4">
                    ...
                    <div class="panel-header border-bottom pb-3 mb-3">
                        <div>
                            <h2 class="h5 mb-1 section-title"><i class="bi bi-card-heading me-2" aria-hidden="true"></i><span>Ubah Informasi Department</span></h2>
                            <p class="text-muted mb-0">Perbarui divisi dan nama department berikut.</p>
                        </div>
                    </div>
