...
@section('title', 'Edit Training Event (COE) | Dharma Learning Center')
    ...
    <div class="container-fluid px-3 px-lg-4 py-4">
        ...
        <div class="d-flex flex-column flex-md-row align-items-md-center justify-content-between gap-3 mb-4">
            <div>
                ...
                <h1 class="h3 mb-0 fw-bold text-dark">Edit Data Training Event</h1>
                <p class="text-muted small mb-0">Perbarui detail pelaksanaan pelatihan, instruktur, ruangan, dan peserta.</p>
            </div>
        ...
        <form action="{{ route('coe.training-event.update', $trainingEvent->id_training_event) }}" method="POST" id="formEditTrainingEvent">
            @csrf
            @method('PUT')
                        ...
                        <div class="col-12 col-md-8">
                            ...
                            <select name="id_event" id="selectEventKalender" class="form-select" onchange="handleEventKalenderChange()">
                                ...
                                <option value="{{ $ev->id_event }}" 
                                        {{ (old('id_event', $trainingEvent->id_event) == $ev->id_event) ? 'selected' : '' }}
                                        data-no="{{ $ev->no_event }}"
                            ...
                            <div class="form-text small">Terkoneksi dengan agenda event kalender pelatihan.</div>
                        </div>
                ...
                <div class="form-section-body">
                    <div class="row g-4">
                        ...
                        <div class="col-12">
                            ...
                            <div class="radio-tile-group">
                                <label class="radio-tile-label">
                                    <input type="radio" name="tipe_penyelenggara" value="Internal" class="radio-tile-input" {{ old('tipe_penyelenggara', $trainingEvent->tipe_penyelenggara) == 'Internal' ? 'checked' : '' }}>
                                ...
                                <label class="radio-tile-label">
                                    <input type="radio" name="tipe_penyelenggara" value="External" class="radio-tile-input" {{ old('tipe_penyelenggara', $trainingEvent->tipe_penyelenggara) == 'External' ? 'checked' : '' }}>
                                    <div class="radio-tile-box">
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <input type="text" name="nama_penyelenggara" id="inputNamaPenyelenggara" list="listProviders" class="form-control" value="{{ old('nama_penyelenggara', $trainingEvent->nama_penyelenggara) }}" required placeholder="Contoh: PT Dharma Polimetal Tbk (DLC) / Nama Lembaga">
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <input type="text" name="trainer" id="inputTrainer" list="listInstructors" class="form-control" value="{{ old('trainer', $trainingEvent->trainer) }}" required placeholder="Ketik nama trainer atau pilih instruktur...">
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <input type="text" name="manager_class" id="inputManagerClass" list="listStaffManagers" class="form-control" value="{{ old('manager_class', $trainingEvent->manager_class) }}" placeholder="Pilih nama staff atau ketik PIC Manager Class...">
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <input type="text" name="ruangan" id="inputRuangan" list="listVenues" class="form-control" value="{{ old('ruangan', $trainingEvent->ruangan) }}" placeholder="Pilih ruangan atau ketik nama venue...">
                ...
                <div class="form-section-body">
                    <div class="row g-3">
                        <div class="col-12 col-md-6">
                            ...
                            <input type="text" name="tipe_evaluasi" list="listTipeEvaluasi" class="form-control" value="{{ old('tipe_evaluasi', $trainingEvent->tipe_evaluasi) }}" placeholder="Pilih atau ketik tipe evaluasi...">
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <input type="text" name="tipe_soal" list="listTipeSoal" class="form-control" value="{{ old('tipe_soal', $trainingEvent->tipe_soal) }}" placeholder="Pilih atau ketik tipe soal...">
            ...
            <div class="form-section-card">
                <div class="form-section-body">
                    <div class="mb-3">
                        ...
                        <textarea name="catatan" rows="3" class="form-control" placeholder="Catatan opsional mengenai persiapan materi, konsumsi, link online meeting, dsb.">{{ old('catatan', $trainingEvent->catatan) }}</textarea>
                    </div>
                    ...
                    <div class="d-flex align-items-center justify-content-between pt-3 border-top">
                        ...
                        <button type="submit" class="btn btn-primary btn-sm px-4 py-2 fw-semibold">
                            <i class="bi bi-check-circle-fill me-1"></i> Simpan Perubahan Training Event
                        </button>
                    </div>
                </div>
            </div>
...
const initialPesertaTna = @json($trainingEvent->peserta_tna ?? []);
const initialPesertaNonTna = @json($trainingEvent->peserta_non_tna ?? []);
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (initialPesertaTna && initialPesertaTna.length > 0) {
        initialPesertaTna.forEach(p => addRowPesertaTna(p));
    } else {
        addRowPesertaTna();
    }

    if (initialPesertaNonTna && initialPesertaNonTna.length > 0) {
        initialPesertaNonTna.forEach(p => addRowPesertaNonTna(p));
    } else {
        addRowPesertaNonTna();
    }
});
