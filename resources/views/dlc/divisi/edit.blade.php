...
@section('title', 'Edit Divisi | Dharma Learning Center')
    ...
    <div class="container-fluid px-3 px-lg-4 py-4">
            ...
            <div class="d-flex flex-column flex-md-row align-items-md-center justify-content-between gap-3">
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div>
                        ...
                        <h1 class="h3 mb-1 fw-bold text-dark">Edit Divisi</h1>
                        <p class="text-muted mb-0 small">Perbarui nama divisi yang telah terdaftar.</p>
                    </div>
                </div>
        ...
        <section class="row g-3">
            <div class="col-12 col-xl-6">
                <form action="{{ route('divisi.update', $divisi->id_divisi) }}" method="POST" class="panel p-4">
                    @csrf
                    @method('PUT')
                    <div class="panel-header border-bottom pb-3 mb-3">
                        <div>
                            <h2 class="h5 mb-1 section-title"><i class="bi bi-card-heading me-2 text-primary" aria-hidden="true"></i><span>Ubah Informasi Divisi</span></h2>
                            <p class="text-muted mb-0 small">Perbarui nama divisi berikut.</p>
                        </div>
                    </div>
                    ...
                    <div class="row g-3">
                        <div class="col-12">
                            ...
                            <input class="form-control" id="nama_divisi" name="nama_divisi" type="text" value="{{ old('nama_divisi', $divisi->nama_divisi) }}" required>
                        </div>
                    </div>
