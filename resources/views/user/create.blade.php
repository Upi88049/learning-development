...
@section('title', 'Tambah Staff | Dharma Learning Center')
      ...
      <div class="d-flex flex-column flex-md-row align-items-md-center justify-content-between gap-3">
        <div class="d-flex align-items-center gap-3">
          ...
          <div>
            ...
            <h1 class="h3 mb-1 fw-bold text-dark">Tambah Staff Baru</h1>
            <p class="text-muted mb-0 small">Isi formulir berikut untuk menambahkan data karyawan baru ke dalam sistem.</p>
          </div>
        </div>
