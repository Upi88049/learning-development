...
@section('title', 'Training Terlaksana | Learning & Development')
  ...
  <div class="container-fluid px-3 px-lg-4 py-4">
    <div class="page-heading">
      <div class="page-heading-copy">
        <span class="page-icon"><i class="bi bi-check2-circle" aria-hidden="true"></i></span>
        <div>
          <p class="eyebrow mb-1">TNA</p>
          <h1 class="h3 mb-1">Total Terlaksana</h1>
          <p class="text-muted mb-0">Daftar training yang telah selesai dilaksanakan (diurutkan berdasarkan Jenis Training)</p>
        </div>
      </div>
    ...
    <section class="panel mt-3">
      <div class="panel-header">
        <div>
          <h2 class="h5 mb-1 section-title"><i class="bi bi-table" aria-hidden="true"></i><span>Training yang Terlaksana</span></h2>
        </div>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-end">
                        ...
                        <button class="btn btn-sm btn-outline-secondary ms-2 py-0 px-2" type="button" data-bs-toggle="collapse" data-bs-target="#staff-detail-t-{{ $t['id_training'] }}" aria-expanded="false" title="Lihat Staff">
                ...
                <tr class="collapse" id="staff-detail-t-{{ $t['id_training'] }}">
                    <td colspan="3" class="bg-light p-3">
                        <small class="fw-bold text-secondary d-block mb-1"><i class="bi bi-people me-1"></i>Daftar Staff Yang Telah Terlaksana:</small>
                        <div class="d-flex flex-wrap gap-2">
                ...
                @empty
                <tr>
                    <td colspan="3" class="text-center text-muted py-4">Belum ada data training yang terlaksana.</td>
                </tr>
                @endforelse
            </tbody>
        </table>
