...
<main class="dashboard-content">
  <div class="container-fluid px-3 px-lg-4 py-4">
    ...
    <section class="panel">
      <div class="panel-header d-flex flex-column flex-md-row align-items-md-center justify-content-between gap-3 pb-3 border-bottom mb-3">
        ...
        <div class="d-flex flex-wrap align-items-center gap-2">
          ...
          <div class="table-entries-selector me-sm-2">
            <span>Show</span>
            <select class="form-select form-select-sm" data-table-entries="permintaanTable">
          ...
          <div class="input-group input-group-sm" style="max-width: 280px;">
            ...
            <input class="form-control border-start-0 ps-0" type="search" placeholder="Cari Training..." data-table-search="permintaanTable" aria-label="Search training">
          </div>
        </div>
      </div>

      <div class="table-responsive">
        <table class="table table-hover align-middle mb-0" id="permintaanTable" data-searchable-table>
          <thead>
            <tr>
      ...
      <div class="table-pagination-footer" data-table-pagination="permintaanTable">
